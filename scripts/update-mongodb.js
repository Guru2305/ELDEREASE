...
const connectionString = 'mongodb+srv://lepto-tech:leptotech%402026@elderease-cluster.hzjanff.mongodb.net/elderease?retryWrites=true&w=majority';

// Environment configuration
const envContent = `# Environment Variables
PORT=5000
MONGODB_URI=mongodb+srv://lepto-tech:leptotech%402026@elderease-cluster.hzjanff.mongodb.net/elderease?retryWrites=true&w=majority
...
try {
  ...
  console.log('✅ Server .env file updated with new credentials!');
  console.log(`📍 Location: ${envPath}`);
  
  console.log('\n🔧 Updated Connection Details:');
  console.log('• Username: lepto-tech');
  console.log('• Password: leptotech@2026 (encoded as leptotech%402026)');
  ...
  console.log('\n🔐 Security Notes:');
  console.log('• Password properly URL-encoded for connection string');
  console.log('• JWT secret configured for development');
  console.log('• CORS settings configured for localhost');
  
} catch (error) {
  console.error('❌ Error updating .env file:', error.message);
}

console.log('\n🎯 MongoDB Atlas connection updated with new credentials!');
